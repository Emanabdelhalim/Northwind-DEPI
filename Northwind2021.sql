...
ALTER DATABASE [Northwind2021] SET ANSI_NULL_DEFAULT OFF 
GO

ALTER DATABASE [Northwind2021] SET ANSI_NULLS OFF 
GO

ALTER DATABASE [Northwind2021] SET ANSI_PADDING OFF 
GO

ALTER DATABASE [Northwind2021] SET ANSI_WARNINGS OFF 
GO

ALTER DATABASE [Northwind2021] SET ARITHABORT OFF 
GO

ALTER DATABASE [Northwind2021] SET AUTO_CLOSE OFF 
GO

ALTER DATABASE [Northwind2021] SET AUTO_SHRINK OFF 
GO

ALTER DATABASE [Northwind2021] SET AUTO_UPDATE_STATISTICS ON 
GO

ALTER DATABASE [Northwind2021] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO

ALTER DATABASE [Northwind2021] SET CURSOR_DEFAULT  GLOBAL 
GO

ALTER DATABASE [Northwind2021] SET CONCAT_NULL_YIELDS_NULL OFF 
GO

ALTER DATABASE [Northwind2021] SET NUMERIC_ROUNDABORT OFF 
GO

ALTER DATABASE [Northwind2021] SET QUOTED_IDENTIFIER OFF 
GO

ALTER DATABASE [Northwind2021] SET RECURSIVE_TRIGGERS OFF 
GO

ALTER DATABASE [Northwind2021] SET  DISABLE_BROKER 
GO

ALTER DATABASE [Northwind2021] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO

ALTER DATABASE [Northwind2021] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO

ALTER DATABASE [Northwind2021] SET TRUSTWORTHY OFF 
GO

ALTER DATABASE [Northwind2021] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO

ALTER DATABASE [Northwind2021] SET PARAMETERIZATION SIMPLE 
GO

ALTER DATABASE [Northwind2021] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [Northwind2021] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [Northwind2021] SET RECOVERY FULL 
GO

ALTER DATABASE [Northwind2021] SET  MULTI_USER 
GO

ALTER DATABASE [Northwind2021] SET PAGE_VERIFY CHECKSUM  
GO

ALTER DATABASE [Northwind2021] SET DB_CHAINING OFF 
GO

ALTER DATABASE [Northwind2021] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Northwind2021] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Northwind2021] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Northwind2021] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [Northwind2021] SET QUERY_STORE = OFF
GO

ALTER DATABASE [Northwind2021] SET  READ_WRITE 
GO
